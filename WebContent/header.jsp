				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=mobile">Cell Phones</a></li>
							<li><a href="index.jsp?type=tv">Televisions</a></li>
							...
							<li><a href="index.jsp?type=kitchen">Kitchen Appliances</a></li>
							<li><a href="index.jsp?type=other">Miscellaneous</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=mobile">Cell Phones</a></li>
							<li><a href="userHome.jsp?type=tv">Televisions</a></li>
							...
							<li><a href="userHome.jsp?type=kitchen">Kitchen Appliances</a></li>
							<li><a href="userHome.jsp?type=other">Miscellaneous</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="adminViewProduct.jsp?type=mobile">Cell Phones</a></li>
							<li><a href="adminViewProduct.jsp?type=tv">Televisions</a></li>
							...
							<li><a href="adminViewProduct.jsp?type=kitchen">Kitchen Appliances</a></li>
							<li><a href="adminViewProduct.jsp?type=other">Miscellaneous</a></li>
						</ul></li>
